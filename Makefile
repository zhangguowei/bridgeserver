...
FULL_LIB_PATH:=$(LIBDIR)/libeice_full.a
...
copyfiles:  $(LIBDIR)/$(PJLIB_LIB) $(LIBDIR)/$(PJLIB_UTIL_LIB) $(LIBDIR)/$(PJNATH_LIB)
#	echo copy libs success
$(LIBDIR)/$(PJLIB_LIB):$(PJLIB_LIB_PATH)
	cp $< $@ 
$(LIBDIR)/$(PJLIB_UTIL_LIB):$(PJLIB_UTIL_LIB_PATH)
	cp $< $@
$(LIBDIR)/$(PJNATH_LIB):$(PJNATH_LIB_PATH)
	cp $< $@
...
clean:
	...
	$(RM) $(C_OBJ)
	$(RM) $(CPP_OBJ)
	$(RM) $(LIBDIR)/$(PJLIB_LIB) $(LIBDIR)/$(PJLIB_UTIL_LIB) $(LIBDIR)/$(PJNATH_LIB)
	$(RM) $(FULL_LIB_PATH)
	$(RM) $(TEST_BIN_PATH)
